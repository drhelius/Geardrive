...
struct qt_meta_stringdata_GLFrame_t {
    QByteArrayData data[1];
    char stringdata[9];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_GLFrame_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_GLFrame_t qt_meta_stringdata_GLFrame = {
    {
...
const QMetaObject GLFrame::staticMetaObject = {
    { &QGLWidget::staticMetaObject, qt_meta_stringdata_GLFrame.data,
      qt_meta_data_GLFrame,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_GLFrame.stringdata))
